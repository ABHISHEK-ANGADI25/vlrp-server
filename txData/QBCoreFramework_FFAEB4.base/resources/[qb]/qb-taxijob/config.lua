Config = {
    ...
    Meter = {
        ['defaultPrice'] = 69.0, -- price per mile
        ['startingPrice'] = 11     -- static starting price
    },
    ...
    NPCLocations = {
        TakeLocations = {
            ...
            [2] = vector4(-395.68, 6126.50, 31.36, 50.04),
            [3] = vector4(240.06, -862.77, 29.73, 341.5),
            [4] = vector4(-248.34, 6406.55, 31.15, 217.36),
            [5] = vector4(1858.52, 2567.41, 45.67, 279.66),
            [6] = vector4(2180.99, 2863.26, 46.97, 286.45),
            [7] = vector4(-1053.23, -2716.2, 13.75, 329.5),
            [8] = vector4(-10.58, 6533.87, 31.44, 241.43),
            [9] = vector4(-1184.3, -1304.16, 5.24, 293.5),
            [10] = vector4(1672.93, 3565.51, 35.55, 207.69),
            [11] = vector4(-419.56, 6125.70, 31.26, 233.26),
            [12] = vector4(1970.89, 3737.10, 32.28, 232.54),
            [13] = vector4(-515.19, -260.29, 35.53, 201.5),
            [14] = vector4(1822.29, 3886.98, 33.75, 209.57),
            [15] = vector4(2363.24, 2528.18, 46.67, 283.01),
            [16] = vector4(-162.29, 6198.10, 31.23, 55.11),
        },

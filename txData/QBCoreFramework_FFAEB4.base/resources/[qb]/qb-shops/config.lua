...
Config.Products = {
        ['normal'] = {
        { name = 'tosti',         price = 30,   amount = 55550 },
        { name = 'water_bottle',  price = 30,   amount = 55550 },
        { name = 'kurkakola',     price = 25,   amount = 5550 },
        { name = 'twerks_candy',  price = 25,   amount = 5550 },
		{ name = 'iphone',         price = 62850, amount = 2250 },
        { name = 'snikkel_candy', price = 50,   amount = 5550 },
        { name = 'sandwich',      price = 50,   amount = 5550 },
        { name = 'beer',          price = 100,   amount = 5550 },
        { name = 'bandage',       price = 5, amount = 55550 },
        { name = 'lighter',       price = 50,   amount = 5550 },
		{ name = 'radio',         price = 2500, amount = 2250 },
		{ name = 'phone',         price = 35850, amount = 2250 },
		{ name = 'fitbit',        price = 4000, amount = 1550 },
        { name = 'cleaningkit',   price = 1000, amount = 15550 },
    },
    ['liquor'] = {
        { name = 'beer',    price = 850,  amount = 50555 },
        { name = 'whiskey', price = 950, amount = 50555 },
		{ name = 'joint',         price = 100,  amount = 55555 },
        { name = 'vodka',   price = 750, amount = 50555 },
		{ name = 'lighter',       price = 50,   amount = 5550 },
		{ name = 'wine', price = 1000, amount = 50555 },
        { name = 'rolling_paper', price = 52,   amount = 5000 },
    },
    ['hardware'] = {
        { name = 'lockpick',          price = 2000, amount = 505 },
        { name = 'weapon_wrench',     price = 1250, amount = 363 },
        { name = 'weapon_hammer',     price = 1250, amount = 250 },
        { name = 'repairkit',         price = 2500, amount = 110, requiredJob = { 'mechanic', 'police' } },
        { name = 'screwdriverset',    price = 1350, amount = 510 },
        { name = 'radio',         price = 2500, amount = 225 },
		{ name = 'phone',         price = 35850, amount = 220 },
        { name = 'binoculars',        price = 250,  amount = 150 },
        { name = 'firework1',         price = 1150,  amount = 150 },
        { name = 'firework2',         price = 1510,  amount = 110 },
        { name = 'firework3',         price = 5110,  amount = 150 },
        { name = 'firework4',         price = 5011,  amount = 101 },
        { name = 'fitbit',        price = 4000, amount = 150 },
        { name = 'cleaningkit',   price = 1050, amount = 550 },
        { name = 'advancedrepairkit', price = 500, amount = 50, requiredJob = 'mechanic' },
    },
    ['weedshop'] = {
        { name = 'joint',         price = 100,  amount = 555 },
        { name = 'weapon_poolcue', price = 100, amount = 50 },
        { name = 'weed_nutrition', price = 20,  amount = 50 },
        { name = 'empty_weed_bag', price = 12,   amount = 200 },
        { name = 'rolling_paper', price = 52,   amount = 500 },
    },
    ['gearshop'] = {
        { name = 'diving_gear', price = 5500, amount = 110 },
        { name = 'jerry_can',   price = 200,  amount = 440 },
    },
    ['leisureshop'] = {
        { name = 'parachute',   price = 2500, amount = 10 },
        { name = 'binoculars',  price = 250,   amount = 5022 },
        { name = 'diving_gear', price = 5500, amount = 1440 },
        { name = 'diving_fill', price = 500,  amount = 10 },
    },
    ['weapons'] = {
        { name = 'weapon_knife',         price = 350,  amount = 235 },
        { name = 'weapon_bat',           price = 750,  amount = 275 },
        { name = 'weapon_hatchet',       price = 450,  amount = 245 },
        { name = 'pistol_ammo',          price = 2500,  amount = 250 },
        { name = 'weapon_pistol',        price = 25000, amount = 55 },
        { name = 'weapon_snspistol',     price = 15000, amount = 50,   requiredLicense = 'weapon' },
        { name = 'weapon_vintagepistol', price = 40000, amount = 45,   requiredLicense = 'weapon' },
		{ name = 'weapon_flashlight',          price = 358,  amount = 250 },
		{ name = 'weapon_fireextinguisher',          price = 2222,  amount = 270 },
		{ name = 'weapon_flaregun',          price = 2254,  amount = 250 },
		{ name = 'armor',          price = 7580,  amount = 202 },
		{ name = 'holoscope_attachment',          price = 1700,  amount = 205 },
		{ name = 'suppressor_attachment',          price = 2500,  amount = 250 },
		{ name = 'weapon_dagger',          price = 450,  amount = 250 },
    },
    ['blackmarket'] = {
    ...
    ['prison'] = {
        { name = 'sandwich',     price = 40, amount = 5770 },
        { name = 'water_bottle', price = 40, amount = 5770 },
    },
    ['police'] = {
